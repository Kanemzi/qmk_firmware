 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |██████|  OS  | LAlt | Lower|    Space    | Raise| AltGr| Left | Down | Right|
 * `-----------------------------------------------------------------------------------'
 */
#define LAYER_BASE_GRID LAYOUT_planck_grid(                                                                                 \
    ...
    KC_LCTL,   XXXXXXX, KC_LGUI, KC_LALT, MO(L_LOWER), KC_SPACE, XXXXXXX, MO(L_RAISE), KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT  \
)
