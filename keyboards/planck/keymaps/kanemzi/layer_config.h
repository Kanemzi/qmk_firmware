 ...
 * | Save |██████|██████|██████|██████|██████|██████| Spd- | Spd+ |██████|██████| Reset|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |██████|██████| NKRO | Debug| UcMod|██████|██████| Hue- | Hue+ |██████|SwAnim|██████|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |██████|██████|██████|██████|██████|██████|██████| Sat- | Sat+ |██████|  Zen |██████|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |██████|██████|██████|██████|██████|█████████████| Lum- | Lum+ |██████|██████| Exit |
...
#define LAYER_CONFIG_GRID LAYOUT_planck_grid(                                                                                            \
    KZ_CFG_SAVE, XXXXXXX, XXXXXXX,           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_SPD, RGB_SPI, XXXXXXX, XXXXXXX,            RESET,   \
    XXXXXXX,     XXXXXXX, MAGIC_TOGGLE_NKRO, DB_TOGG, UC_NEXT, XXXXXXX, XXXXXXX, RGB_HUD, RGB_HUI, XXXXXXX, RGB_MOD,            XXXXXXX, \
    XXXXXXX,     XXXXXXX, XXXXXXX,           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_SAD, RGB_SAI, XXXXXXX, TOGGLE_LAYER_COLOR, XXXXXXX, \
...
#define LAYER_CONFIG_LEDMAP {                                                          \
    ...
    BLACK, BLACK, BLUE,  BLUE,  BLUE,  BLACK, BLACK, PINK, CYAN, BLACK, TEAL,   BLACK, \
    BLACK, BLACK, BLACK, BLACK, BLACK, BLACK, BLACK, PINK, CYAN, BLACK, PURPLE, BLACK, \
