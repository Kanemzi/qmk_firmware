...
#define LAYER_CONFIG_GRID LAYOUT_planck_grid(                                                                       \
    ...
    _______,     KZ_TG_ALT_LOWER, NK_TOGG, DB_TOGG, UC_NEXT, XXXXXXX, XXXXXXX, RGB_HUD, RGB_SAD, RGB_VAD, XXXXXXX, XXXXXXX, \
...
#define LAYER_CONFIG_LEDMAP {                                                           \
    ...
    BLACK, RED,   RED,   RED,   RED,   BLACK, BLACK, RED,   RED,   RED,   BLACK, BLACK, \
