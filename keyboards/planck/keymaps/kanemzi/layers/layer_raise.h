...
#define LAYER_RAISE_GRID LAYOUT_planck_grid(                                                                         \
    ...
    _______,   FR_CIRC, FR_LBRC, FR_LPRN, FR_LCBR, FR_DQUO, _______, FR_RCBR, FR_RPRN, FR_RBRC, FR_DLR,  X(HCADR),    \
    _______,   FR_BSLS, FR_TILD, FR_CCED, FR_UGRV, FR_AMPR, FR_PIPE, FR_GRV , _______, FR_HASH, FR_EXLM, X(MIDDOT),  \
...
#define LAYER_RAISE_LEDMAP {                                                                   \
    ...
    BLACK, WHITE,  GOLD,   GOLD,    GOLD,    WHITE, BLACK, GOLD,  GOLD,  GOLD,  WHITE, WHITE,  \
    BLACK, WHITE,  WHITE,   PURPLE, PURPLE,  WHITE, WHITE, WHITE, BLACK, WHITE, WHITE, WHITE,  \
