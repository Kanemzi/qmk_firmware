...
#define LAYER_RAISE_GRID LAYOUT_planck_grid(                                                                         \
    KC_DELETE, FR_AGRV, FR_EACU, FR_EGRV, FR_LABK, _______, FR_QUOT, FR_RABK, FR_UNDS, FR_AT,   _______, _______,    \
...
#define LAYER_RAISE_LEDMAP {                                                                   \
    RED,   PURPLE, PURPLE, PURPLE, GOLD,    BLACK, PINK, GOLD,   PINK,  PINK,  BLACK, BLACK,  \
    BLACK, PINK,   GOLD,   GOLD,   GOLD,    PINK,  PINK, GOLD,   GOLD,  GOLD,  PINK,  BLACK,  \
    BLACK, PINK,   PINK,   PURPLE, PURPLE,  PINK,  PINK, PINK,   BLACK, PINK,  PINK,  BLACK,  \
