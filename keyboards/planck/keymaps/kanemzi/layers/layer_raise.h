...
#define LAYER_RAISE_GRID LAYOUT_planck_grid(                                                                         \
    ...
    _______,   FR_CIRC, FR_LBRC, FR_LPRN, FR_LCBR, FR_DQUO, _______, FR_RCBR, FR_RPRN, FR_RBRC, FR_DLR,  _______,    \
...
#define LAYER_RAISE_LEDMAP {                                                                   \
    ...
    BLACK, WHITE,  GOLD,   GOLD,    GOLD,    WHITE, BLACK, GOLD,  GOLD,  GOLD,  WHITE, BLACK,  \
